...
type telegraf_global_tags = extensible {
};
...
type telegraf_plugin_common = {
    ...
    # An array of glob pattern strings. Only metrics whose measurement name matches a pattern in this list are emitted.
    ...
    # An array of glob pattern strings. Only fields whose field key matches a pattern in this list are emitted.

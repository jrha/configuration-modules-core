...
use Test::NoWarnings;
use Test::Quattor qw(ipv4 dualstack);
...
Readonly my $HOSTSFILE_INITIAL_DUALSTACK =>
'127.0.0.1   localhost localhost.localdomain localhost4 localhost4.localdomain4
::1         localhost localhost.localdomain localhost6 localhost6.localdomain6
';

Readonly my $HOSTSFILE_EXPECTED_DUALSTACK =>
'# Generated by Quattor component hostsfile 2.0.0
127.0.0.1   localhost localhost.localdomain localhost4 localhost4.localdomain4
::1         localhost localhost.localdomain localhost6 localhost6.localdomain6
192.168.42.1	priv_1                      # NCM Private Four One
192.168.42.2	priv_2                      # NCM Private Four Two
fd42:2a:2112:1::3	priv_3                  # NCM Private Six Three
';
...
$config = get_config_for_profile('dualstack');
$file_contents = '';
is($cmp->Configure($config), 1, 'Component runs correctly with profile (dualstack)');
is($file_contents, $HOSTSFILE_EXPECTED_DUALSTACK, 'Hostsfile updated with correct contents (dualstack)');

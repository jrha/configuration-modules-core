...
=item * C<< /software/components/hostsfile/file >>

The filename to modify, defaults to C<< /etc/hosts >>.

=item * C<< /software/components/hostsfile/entries >>
...
=item * C<< /software/components/hostsfile/takeover >>
